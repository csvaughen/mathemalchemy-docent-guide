...
**In the exhibit:** [[Lebesgue Terrace]]
...
Lebesgue's own analogy: a shopkeeper can count the till coin-by-coin as received (Riemann) or sort coins by denomination first (Lebesgue).

**One-liner for tours:** "Sometimes the smartest way to measure something complicated is to slice it sideways."
