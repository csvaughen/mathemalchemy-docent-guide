...
## What it is
**Two** arches of thread-wrapped balls rising above the garden: one illustrates a **converging geometric series** (it reaches upward), the other a **diverging series** (it plunges into the bay). Ball diameters follow the ratio $(n/(n+1))^{2/3}$. Infinitely many balls, finite total height on the convergent side — you are literally looking at an infinite sum equaling a finite number.

**Easter egg:** of the 120+ balls, **exactly 22 are embroidered — the ones at twin-prime indices** — in the Japanese **temari** folk art, tying the arches to the primes theme in the garden below. 

## Docent questions
- "If we kept adding smaller and smaller balls forever, would the arch hit the ceiling — or stop at a certain height?"
- "Did you know you're seeing an infinite sum equal a finite number?"
- "Where do we need systems that grow but stay bounded?" (debt, energy use, resource management)
