---
tags: [scene]
math: [fractals, mandelbrot-set, iteration, tessellations, symmetry]
...
- **The names are the joke:** Arnold honors **Vladimir Arnold** — folding pastry dough evokes the stretching/compressing of dynamical systems (**Arnold's cat map** is hidden in the décor). The assistant's odd spelling, **Mo[u]se**, honors **Jürgen Moser** — cat and mouse together complete the **KAM (Kolmogorov–Arnold–Moser) theorem**.
